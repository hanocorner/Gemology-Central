    ...
    <div class="form-row">
      ...
      <div class="form-group col-3">
        ...
        <?php if(isset($result->memoid)): ?>
          <input type="text" class="form-control form-control-sm" name="rmid" value="<?php echo $result->memoid; ?>" readonly>
        <?php endif; ?>
    ...
    <div class="form-row">
      <div class="col-3">
        ...
        <div class="input-group input-group-sm mb-3">
          ...
          <input type="text" class="form-control" name="amount" value="<?php echo $result->mem_amount; ?>" required autocomplete="off">
        </div>
      </div>
      ...
      <div class="col-md-3">
        <div class="custom-file-container" data-upload-id="myUploader">
          ...
          <div class="custom-file-container__image-preview">
            <img src="<?php echo base_url(); ?>assets/admin/images/gem/<?php echo $result->rep_imagename; ?>" width="330" height="250" alt="Gem Image">
          </div>
        </div>
      </div>
      <div class="col-4">
