...
class Customer extends Admin_Controller
{
  ...
  {
    $this->layout->title = 'My Customer List';
  ...
  public function add()
  {
    $this->layout->title = 'Add new Customer';
    $this->layout->assets('assets/admin/js/report.js');
    $this->layout->assets('assets/admin/js/jquery.form-validator.min.js');

    return $this->layout->view('admin/lab/customer/add');
  }
