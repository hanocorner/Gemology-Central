...
class Report_model extends CI_Model
{
  ...
  {
    $token = (string) $token;
    $sql = "SELECT qrtoken, date, object, variety, spgroup, dimensions, weight, shapecut, color, comment, web_comment, gemstone, imgpath, repoid FROM public_fetch_report WHERE qrtoken = '".$token."' ";
