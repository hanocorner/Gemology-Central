CREATE VIEW admin_print_populate_frep
AS 
SELECT t1.reportid, DATE_FORMAT(t1.created_date, "%Y/%m/%e") AS date, t1.object, t1.spgroup, t1.weight, CONCAT(t1.gemWidth, ' X ', t1.gemHeight, ' X ', t1.gemLength) AS dimensions,
