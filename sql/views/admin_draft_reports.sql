CREATE VIEW admin_draft_reports
AS 
SELECT t2.reportid AS reportno, CONCAT(t1.firstname, " ", t1.lastname) AS customer, t2.type, t2.weight, t2.color, t2.shapecut, t2.gemWidth, t3.name AS variety, COALESCE(t4.id, t5.id, t6.id) AS reportid,
